...
## SRC_FILES (RcppExports.cpp) are automatically generated by devtools.
src/RcppExports.cpp: $(SRC_FILES)
	Rscript -e "library(devtools); document()" && rm -f src/*.o src/*.so
...
check: $(PKG_NAME)_$(PKG_VERSION).tar.gz
	R CMD check ./$(PKG_NAME)_$(PKG_VERSION).tar.gz | tee cran-check.txt
